...
public class SplashPage {
    ...
    public void instructions(){
        createAscii("gobigorgohome2/resources/banner.txt");
        ...
        createAscii("gobigorgohome2/resources/instructions.txt");
        System.out.println("\033[31;4;1m!!!IMPORTANT!!!:\033[0m");
        createAscii("gobigorgohome2/resources/instructions2.txt");
